...
<div class="row">
            ...
            <div class="card-tools">
                <div class="input-group input-group-sm">
                    <div class="input-group-append">
                        <a href="{{ route('item_ad.index') }}" class="btn btn-default">アイテムリストに戻る</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary">
        <form action="{{ route('item_ad.update', ['id'=> $item->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="card-body">
    ...
    <!-- 削除ボタン -->
    <form action="{{ route('item_ad.destroy', ['id'=> $item->id]) }}" method="POST" onsubmit="return submitCheck()">
        {{ csrf_field() }}
        {{ method_field('DELETE') }}
        <div class="card-footer">
