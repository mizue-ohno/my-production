...
@section('title', '管理者：アイテムリスト')

@section('content_header')
<h1>管理者ページ：アイテムリスト</h1>
@stop
...
<div class="item_search">
    <form action="{{ route('item_ad.index') }}" method="GET">
        <label for="">キーワード
            <div>
                ...
                <div class="card-tools">
                    <div class="input-group input-group-sm">
                        <div class="input-group-append">
                            <a href="{{ route('item_ad.create') }}" class="btn btn-default">新規アイテム登録</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    @if ($item->image)
                        ...
                        <div class="card-body">
                            ...
                            <h7>登録者：@if ($item->user){{ $item->user_id->name }} @endif</h7>
